...
const optionalEnvVars = {
  ...
  // LLM Provider (OpenAI SDK pattern — works with Azure AI Foundry, OpenAI, Together, Groq, etc.)
  // Swap providers by changing these env vars — zero code changes
  OPENAI_BASE_URL: process.env.OPENAI_BASE_URL,
  OPENAI_API_KEY: process.env.OPENAI_API_KEY,
  OPENAI_MODEL: process.env.OPENAI_MODEL || 'gpt-oss-120b',
  OPENAI_API_VERSION: process.env.OPENAI_API_VERSION || '2024-10-21',  // Azure only
  // Embeddings (same provider pattern)
  EMBEDDING_MODEL: process.env.EMBEDDING_MODEL || 'text-embedding-3-small',
  // Embedding Configuration (Azure text-embedding-3-small = 1536 dimensions)
