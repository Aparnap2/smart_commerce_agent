...
async def create_support_subgraph(redis_url: str):
    ...
    builder.add_node("decider", decision_node)  # Renamed from "decision" to avoid state key conflict
    builder.add_node("render", render_support_node)
    builder.add_edge(START, "context")
    builder.add_edge("context", "policy_rag")
    builder.add_edge("policy_rag", "decider")
    builder.add_edge("decider", "render")
